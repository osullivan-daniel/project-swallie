...
The 2026 version of this project started prety much 6 years to the day it was put down. Built before the advent of AI off of stalk overflow and youtube tutorials, it was solely angular with hard coded values
...
Although AI might be helping as a pair programer to bounce things off of as in 2026 its much better than stalkoverflow!

## Current Status

The application is currently in a usable/demoable state. The core
admin workflow is implemented and the application can be run
locally using Docker.

## Next Steps

- [ ] Review use of enums - text value should only be uused for displaying but ther is a disconect FastApi si expecting the text value at the moment - this effects both Order Staus and Variant size
